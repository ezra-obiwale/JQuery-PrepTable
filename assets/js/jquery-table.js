(function () {
    ...
    jQuery.fn.table = function (settings) {
        ...
        function createLimit(id) {
            ...
            $select = $('#' + id + ' .before-table').append('<label class="jq-limit">Show <select /> entries</label>')
        ...
        function createSearch(id) {
            $label = $('#' + id + ' .before-table').append('<label class="jq-search">Search <input type="text" /></label>')
